          ...
          <Container>
            ...
            <Row>
              <Col className='d-flex justify-content-center mt-1'>
                <img className='image-radius' src={require('../Assets/BeeBoy.png')} width={100} height={100} alt="Logo" />
                <img className='image-radius' src={require('../Assets/BeeGirl.png')} width={100} height={100} alt="Logo" />
              </Col>
            </Row>

            <Row>
              <Col>
                <p className='text-center top-text-bold'>Step 1</p>
